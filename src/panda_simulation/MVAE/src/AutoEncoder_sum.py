...
class AutoEncoder(nn.Module):
    ...
    def get_dictionaries(self):
       ...
       for i in range(100000):
           validation_list.append(str(i+400000))
    ...
    def train_net(self, net, network_id, max_epochs , batch_size):
        ...
        precision_y = np.zeros((1, 1, 128, 128))   # THAT'S STD MATRIX OF IMAGES
        precision_y[0, 0] = np.loadtxt('Im_STD.csv', delimiter=',')
        precision_y = torch.tensor(np.float32(self.precision_y),
        ...
        for epoch in range(max_epochs):
            ...
            for local_batch, local_labels in training_generator:
                ...
                loss, MSE_Im, MSE_z1, output_x = AutoEncoder.run_batch(local_batch, local_labels, True, net, optimizer, criterion, device, precision_y)
            ...
            if epoch % 10 == 0 and epoch<max_epochs-1:
                ...
                for local_batch, local_labels in validation_generator:
                    net.eval
                    loss, MSE_Im, MSE_mu = AutoEncoder.run_batch(local_batch, local_labels, False, net, optimizer, criterion, device, precision_y)
    ...
    def run_batch(x, y, train, net, optimizer, criterion , device, precision_y):
        """
        ...
        MSE_Im = criterion(output_y + precision_y*output_y, target_y + precision_y*target_y)
        ...
        return loss.item(), MSE_Im, MSE_mu
